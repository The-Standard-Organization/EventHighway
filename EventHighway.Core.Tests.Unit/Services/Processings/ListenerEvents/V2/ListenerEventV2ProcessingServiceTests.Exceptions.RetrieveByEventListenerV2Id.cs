...
namespace EventHighway.Core.Tests.Unit.Services.Processings.ListenerEvents.V2
{
    public partial class ListenerEventV2ProcessingServiceTests
    {
        ...
        public async Task ShouldThrowServiceExceptionOnRetrieveByEventListenerV2IdIfExceptionOccursAndLogItAsync()
        {
            ...
            // when
            ValueTask<IEnumerable<ListenerEventV2>> retrieveByEventListenerV2IdTask =
                this.listenerEventV2ProcessingService
                    .RetrieveListenerEventV2sByEventListenerV2IdAsync(
                        someEventListenerV2Id, randomCancellationToken);
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveByEventListenerV2IdIfDependencyErrorOccursAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRetrieveByEventListenerV2IdIfValidationErrorOccursAndLogItAsync(
