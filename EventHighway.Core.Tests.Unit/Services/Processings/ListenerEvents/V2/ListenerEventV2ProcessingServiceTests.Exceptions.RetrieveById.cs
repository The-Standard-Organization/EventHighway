...
namespace EventHighway.Core.Tests.Unit.Services.Processings.ListenerEvents.V2
{
    public partial class ListenerEventV2ProcessingServiceTests
    {
        ...
        public async Task ShouldThrowServiceExceptionOnRetrieveByIdIfExceptionOccursAndLogItAsync()
        {
            ...
            // when
            ValueTask<ListenerEventV2> retrieveByIdTask =
                this.listenerEventV2ProcessingService
                    .RetrieveListenerEventV2ByIdAsync(someListenerEventV2Id, randomCancellationToken);
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRetrieveByIdIfValidationErrorOccursAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveByIdIfTimeoutOccursAndLogItAsync()
        {
            ...
            ValueTask<ListenerEventV2> retrieveByIdTask =
                this.listenerEventV2ProcessingService
                    .RetrieveListenerEventV2ByIdAsync(
