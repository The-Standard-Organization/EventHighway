...
namespace EventHighway.Core.Services.Foundations.EventArchives.V1
{
    internal partial class EventArchiveV1Service
    {
            ...
            ReturningEventArchiveV1Function returningEventArchiveV1Function)
        {
            ...
            catch (NullEventArchiveV1Exception nullEventArchiveException)
            {
                throw await CreateAndLogValidationExceptionAsync(
                    nullEventArchiveException);
            }
            catch (InvalidEventArchiveV1Exception invalidEventArchiveException)
            {
                throw await CreateAndLogValidationExceptionAsync(
                    invalidEventArchiveException);
            }
        ...
        private async ValueTask<IQueryable<EventArchiveV1>> TryCatch(
            ReturningEventArchivesV1Function returningEventArchivesFunction)
        {
            try
            {
