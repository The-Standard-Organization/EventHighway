        ...
        public async Task ShouldThrowCriticalDependencyExceptionOnBulkAddIfSqlErrorOccursAndLogItAsync()
        {
            ...
            this.storageBrokerMock.Setup(broker =>
                broker.InsertBulkEventListenerArchiveV2sAsync(
                    It.IsAny<List<EventListenerArchiveV2>>(),
                        It.IsAny<CancellationToken>()))
                            .ThrowsAsync(sqlException);

            // when
            ValueTask<IEnumerable<EventListenerArchiveV2>> bulkAddEventListenerArchiveV2sTask =
                this.eventListenerArchiveV2Service.BulkAddEventListenerArchiveV2sAsync(
            ...
            EventListenerArchiveV2DependencyException actualEventListenerArchiveV2DependencyException =
                await Assert.ThrowsAsync<EventListenerArchiveV2DependencyException>(
                    bulkAddEventListenerArchiveV2sTask.AsTask);
