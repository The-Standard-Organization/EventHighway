...
namespace EventHighway.Core.Tests.Unit.Services.Processings.EventParticipants.V2
{
    ...
    {
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveOrAddIfTimeoutOccursAndLogItAsync()
        {
            // given
        ...
        public async Task
            ShouldThrowDependencyValidationOnRetrieveOrAddIfDependencyValidationErrorOccursAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveOrAddIfDependencyErrorOccursAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveOrAddIfServiceErrorOccursAndLogItAsync()
        {
            // given
            CancellationToken randomCancellationToken = TestContext.Current.CancellationToken;
            EventParticipantV2 someEventParticipantV2 = CreateRandomEventParticipantV2();
            ...
            // then
            actualEventParticipantV2ProcessingServiceException.Should().BeEquivalentTo(
