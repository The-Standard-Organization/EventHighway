    ...
    public partial class EventParticipantV2ProcessingServiceTests
    {
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveByQueryIfTimeoutOccursAndLogItAsync()
        {
            ...
            ValueTask<IReadOnlyList<EventParticipantV2>> retrieveAllEventParticipantV2sTask =
                this.eventParticipantV2ProcessingService.RetrieveEventParticipantV2sByQueryAsync(new EventParticipantV2Query(), 
        ...
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveByQueryAsync()
        {
            ...
            // when
            ValueTask<IReadOnlyList<EventParticipantV2>> retrieveAllEventParticipantV2sTask =
                this.eventParticipantV2ProcessingService.RetrieveEventParticipantV2sByQueryAsync(new EventParticipantV2Query(), cancelledToken);
            ...
            Xeption dependencyException)
        {
            ...
            // when
            ValueTask<IReadOnlyList<EventParticipantV2>> retrieveAllTask =
                this.eventParticipantV2ProcessingService.RetrieveEventParticipantV2sByQueryAsync(new EventParticipantV2Query(), 
