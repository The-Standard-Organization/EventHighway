...
namespace EventHighway.Core.Tests.Unit.Services.Foundations.ListenerEventArchives.V2
{
    ...
    {
        [Fact]
        public async Task ShouldRetrieveListenerEventArchiveV2sByQueryAsync()
        {
            // given
            ...
            IReadOnlyList<ListenerEventArchiveV2> actualListenerEventArchiveV2s =
                await this.listenerEventArchiveV2Service.RetrieveListenerEventArchiveV2sByQueryAsync(
