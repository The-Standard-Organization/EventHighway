...
namespace EventHighway.Portal.Web.Tests.Unit.Services.Views.UserEventParticipants
{
    public partial class UserEventParticipantsViewServiceTests
    {
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnIsUserAssociatedWithParticipantWhenErrorOccursAsync()
        {
            // given
            Guid inputUserId = GetRandomGuid();
            ...
            // when
            ValueTask<bool> isAssociatedTask =
                this.userEventParticipantsViewService.IsUserAssociatedWithParticipantAsync(
                    inputUserId, inputParticipantId, TestContext.Current.CancellationToken);

            UserEventParticipantsViewServiceException actualException =
                await Assert.ThrowsAsync<UserEventParticipantsViewServiceException>(
                    isAssociatedTask.AsTask);
