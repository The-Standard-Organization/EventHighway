    ...
    public partial class EventHandlerV2ProcessingServiceTests
    {
            ...
            Xeption dependencyException)
        {
            ...
            ValueTask<IQueryable<EventHandlerV2>> retrieveAllEventHandlerV2sTask =
                this.eventHandlerV2ProcessingService.RetrieveAllEventHandlerV2sAsync(
        ...
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveAllAsync()
        {
            ...
            // when
            ValueTask<IQueryable<EventHandlerV2>> retrieveAllEventHandlerV2sTask =
                this.eventHandlerV2ProcessingService.RetrieveAllEventHandlerV2sAsync(cancelledToken);
