...
namespace EventHighway.Core.Tests.Unit.Services.Coordinations.HealthChecks.V2
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveDuplicateReportV2Async()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveDuplicateReportV2IfTimeoutOccursAndLogItAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveDuplicateReportV2IfDependencyExceptionOccursAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRetrieveDuplicateReportV2IfDependencyValidationErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveDuplicateReportV2IfServiceErrorOccursAndLogItAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
