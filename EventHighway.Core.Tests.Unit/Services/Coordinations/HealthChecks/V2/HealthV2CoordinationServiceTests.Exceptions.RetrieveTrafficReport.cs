...
namespace EventHighway.Core.Tests.Unit.Services.Coordinations.HealthChecks.V2
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveTrafficReportV2Async()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveTrafficReportV2IfTimeoutOccursAndLogItAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveTrafficReportV2IfDependencyExceptionOccursAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRetrieveTrafficReportV2IfDependencyValidationErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveTrafficReportV2IfServiceErrorOccursAndLogItAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
