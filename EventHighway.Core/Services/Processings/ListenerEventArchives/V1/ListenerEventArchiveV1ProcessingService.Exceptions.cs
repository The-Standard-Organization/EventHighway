...
namespace EventHighway.Core.Services.Processings.ListenerEventArchives.V1
{
    internal partial class ListenerEventArchiveV1ProcessingService
    {
            ...
            ReturningListenerEventArchiveV1Function returningListenerEventArchiveV1Function)
        {
            ...
            {
                throw await
                    CreateAndLogDependencyValidationExceptionAsync(ListenerEventArchiveV1DependencyValidationException);
            }
        ...
        private async ValueTask<ListenerEvenArchiveV1ProcessingValidationException>
            CreateAndLogValidationExceptionAsync( Xeption exception)
        {
            var ListenerEventArchiveV1ProcessingValidationException =
                new ListenerEvenArchiveV1ProcessingValidationException(
        ...
        private async ValueTask<ListenerEventArchiveV1ProcessingDependencyException>
        ...
        private async ValueTask<ListenerEventArchiveV1ProcessingServiceException>
