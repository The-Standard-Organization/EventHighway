...
namespace EventHighway.Core.Tests.Unit.Services.Coordinations.HealthChecks.V2
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveLoopDetectionReportV2Async()
        {
            // given
            ...
            ValueTask<HealthReportV2> retrieveHealthReportTask =
                this.healthV2CoordinationService.RetrieveLoopDetectionReportV2Async(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveLoopDetectionReportV2IfTimeoutOccursAndLogItAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveLoopDetectionReportV2IfDependencyExceptionOccursAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRetrieveLoopDetectionReportV2IfDependencyValidationErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveLoopDetectionReportV2IfServiceErrorOccursAndLogItAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
