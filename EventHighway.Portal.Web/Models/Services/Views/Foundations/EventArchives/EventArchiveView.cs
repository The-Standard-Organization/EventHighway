...
namespace EventHighway.Portal.Web.Models.Services.Views.Foundations.EventArchives
{
    public class EventArchiveView
    {
        ...
        // Aggregate delivery outcome across the archived event's listener events: all
        // succeeded -> Success, all failed -> Error, some of each -> Partial Success.
        // Quarantined events were never dispatched; no listener events -> Pending.
