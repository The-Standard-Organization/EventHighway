...
namespace EventHighway.Core.Tests.Unit.Services.Processings.EventArchives.V1
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnRetrieveByIdIfEventV1ArchiveIdIsInvalidAndLogItAsync()
        {
            // given
            ...
            ValueTask<EventV1Archive> retrieveEventV1ArchiveByIdTask =
                this.eventV1ArchiveProcessingService.RetrieveEventV1ArchiveByIdAsync(invalidEventV1ArchiveId);
            ...
            this.eventV1ArchiveServiceMock.Verify(service =>
                service.RetrieveEventV1ArchiveByIdAsync(
                    It.IsAny<Guid>()),
                        Times.Never);
