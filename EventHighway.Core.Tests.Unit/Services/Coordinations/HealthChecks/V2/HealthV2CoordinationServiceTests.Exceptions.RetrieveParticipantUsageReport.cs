...
namespace EventHighway.Core.Tests.Unit.Services.Coordinations.HealthChecks.V2
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveParticipantUsageReportV2Async()
        {
            // given
            ...
            ValueTask<HealthReportV2> retrieveHealthReportTask =
                this.healthV2CoordinationService.RetrieveParticipantUsageReportV2Async(
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveParticipantUsageReportV2IfTimeoutOccursAndLogItAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveParticipantUsageReportV2IfDependencyExceptionOccursAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRetrieveParticipantUsageReportV2IfDependencyValidationErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveParticipantUsageReportV2IfServiceErrorOccursAndLogItAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
