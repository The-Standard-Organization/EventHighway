    ...
    public partial class EventListenerV1OrchestrationServiceTests
    {
            ...
            Xeption listenerEventV1ValidationException)
        {
            ...
            this.listenerEventV1ProcessingServiceMock.Setup(service =>
                service.AddListenerEventAsync(It.IsAny<ListenerEventV1>()))
                    .ThrowsAsync(listenerEventV1ValidationException);

            // when
            ValueTask<ListenerEventV1> addListenerEventV1Task =
                this.eventListenerV1OrchestrationService.AddListenerEventAsync(someListenerEventV1);
        ...
        public async Task ShouldThrowServiceExceptionOnAddListenerEventV1IfExceptionOccursAndLogItAsync()
        {
            ...
            // when
            ValueTask<ListenerEventV1> addListenerEventV1Task =
                this.eventListenerV1OrchestrationService.AddListenerEventAsync(
                    someListenerEventV1);
