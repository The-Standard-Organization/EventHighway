...
{
    /// <inheritdoc />
    public partial class AddEventV2Models : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "EventAddressesV2",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventAddressesV2", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HandlerParams = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventListenersV2_EventAddressesV2_EventAddressId",
                        column: x => x.EventAddressId,
                        principalTable: "EventAddressesV2",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventV2s_EventAddressesV2_EventAddressId",
                        column: x => x.EventAddressId,
                        principalTable: "EventAddressesV2",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ListenerEventsV2_EventAddressesV2_EventAddressId",
                        column: x => x.EventAddressId,
                        principalTable: "EventAddressesV2",
                        principalColumn: "Id");
                    table.ForeignKey(
