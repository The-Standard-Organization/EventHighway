...
namespace EventHighway.Core.Tests.Unit.Services.Coordinations.HealthChecks.V2
{
    ...
    {
        [Fact]
        public async Task ShouldThrowOperationCanceledExceptionRawWhenCancellationIsRequestedOnRetrieveHealthCheckItemsReportV2Async()
        {
            // given
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionOnRetrieveHealthCheckItemsReportV2IfTimeoutOccursAndLogItAsync()
        {
            // given
        ...
        public async Task ShouldThrowDependencyExceptionOnRetrieveHealthCheckItemsReportV2IfDependencyExceptionOccursAndLogItAsync(
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnRetrieveHealthCheckItemsReportV2IfDependencyValidationErrorOccursAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnRetrieveHealthCheckItemsReportV2IfServiceErrorOccursAndLogItAsync()
        {
            // given
            CancellationToken randomCancellationToken =
                TestContext.Current.CancellationToken;
